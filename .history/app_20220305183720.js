...
app.post('/api/log', (req, res) => {
  ...
  res.status(200).send({ token: 'This is  token' })
})
...
app.use(express.static(path.join(__dirname, '../public/.next/server/pages')))
app.get('/*', function (req, res) {
  res.status(200).sendFile(path.join(__dirname, '/public/.next/server/pages', 'index.html'))
})
